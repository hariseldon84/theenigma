...
Epics are split into individual files for development:

| Epic | File | Phase |
|------|------|-------|
| **Epic 1: Memory Foundation** | [epic-1-memory-foundation.md](./epics/epic-1-memory-foundation.md) | MVP |
| **Epic 2: Ambient Ingestion** | [epic-2-ambient-ingestion.md](./epics/epic-2-ambient-ingestion.md) | MVP |
| **Epic 3: Strategic Executive Proxy** | [epic-3-strategic-executive-proxy.md](./epics/epic-3-strategic-executive-proxy.md) | MVP |
| **Epic 4: Action Sphere UI** | [epic-4-action-sphere-ui.md](./epics/epic-4-action-sphere-ui.md) | MVP |
| **Epic 5: Thought Memory & Audio Thought Capture** | [epic-5-thought-memory-audio-thought-capture.md](./epics/epic-5-thought-memory-audio-thought-capture.md) | Post-MVP |
